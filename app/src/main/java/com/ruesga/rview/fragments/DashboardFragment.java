...
public class DashboardFragment extends PageableFragment {
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        if (ModelHelper.isEqualsOrGreaterVersionThan(account, 3.10d)) {
            mDefaultDashboardTabs = getResources().getStringArray(R.array.dashboard_titles_3_10);
            mDefaultDashboardFilters = getResources().getStringArray(R.array.dashboard_filters_3_10);
            mDefaultDashboardReverse = getResources().getStringArray(
                    Preferences.isAccountDashboardOngoingSort(getActivity(), account)
                            ? R.array.dashboard_sort_inverse_3_10
                            : R.array.dashboard_sort_3_10);
        } else if (ModelHelper.isEqualsOrGreaterVersionThan(account, 3.7d)) {
